...
// const totalGames = GAMES_JSON.reduce( (acc, game) => { return acc + game }, 0)
...
let unfundedGamesCount = GAMES_JSON.reduce( ( acc, game ) => { return game.pledged < game.goal ? acc + 1 : acc + 0}, 0) // using reduce instead of filter works!

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `Currently, ${unfundedGamesCount} ${unfundedGamesCount > 1 ? "games" : "game"} remains unfunded. We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const newStrDiv = document.createElement('p')
newStrDiv.innerHTML = displayStr
descriptionContainer.append(newStrDiv)
...
const topFundedDiv = document.createElement('p')
topFundedDiv.innerHTML = firstGame.name
firstGameContainer.append(topFundedDiv)

// do the same for the runner up item
const runnerUpDiv = document.createElement('p')
runnerUpDiv.innerHTML = secondGame.name
